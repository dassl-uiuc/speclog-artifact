...
with open('{0}/failure/e2e_2000/client_node13_0.log'.format(results_dir), 'r') as f:
...
path='{0}/failure/e2e_2000/e2e_metrics_*.csv'.format(results_dir)
...
path='{0}/failure/e2e_2000/append_metrics_*.csv'.format(results_dir)
...
with open('{0}/failure/e2e_2000/order-0.log'.format(results_dir), 'r') as f:
    for line in f.readlines():
