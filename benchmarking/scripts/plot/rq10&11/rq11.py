...
subprocess.run(["bash"], input="mv fail_e2e_shard.pdf 17b_e2e.pdf", text=True)
subprocess.run(["bash"], input="mv fail_tput_shard.pdf 17b_tput.pdf", text=True)
subprocess.run(["bash"], input="mv fail_e2e_replica.pdf 17a_e2e.pdf", text=True)
subprocess.run(["bash"], input="mv fail_tput_replica.pdf 17a_tput.pdf", text=True)
subprocess.run(["bash"], input="mv breakdown.pdf 17c.pdf", text=True)