...
for path in glob.glob(results_dir + "/e2e/speclog/e2e_4shard/*"):
...
for path in glob.glob(results_dir + "/e2e/scalog/e2e_4shard/*"):
...
subprocess.run(['bash'], input="mv splitup.pdf 8c.pdf", text=True)
# subprocess.run(['bash'], input="mv benefitratio.pdf 8b.pdf", text=True)
subprocess.run(['bash'], input="mv e2evscompute.pdf 8a.pdf", text=True)
subprocess.run(['bash'], input="mv benefitratio-kink.pdf 8b.pdf", text=True)
