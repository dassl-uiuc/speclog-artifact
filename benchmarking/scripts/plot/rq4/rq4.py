...
suffix = 'with_e2e'
logfile1 = results_dir + "/lagfix_" + suffix + "/data-0-0.log"
logfile2 = results_dir + "/lagfix_" + suffix + "/order-0.log"
logfile3 = "output.log"
...
subprocess.run(['bash'], input="mv cuts.pdf 10b.pdf", text=True)
subprocess.run(['bash'], input="mv lagfix_e2e.pdf 10a.pdf", text=True)
