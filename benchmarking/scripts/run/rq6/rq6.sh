...
mkdir -p "$benchmark_dir/results/reconfig_${computation_time}_scalog_with_e2e"
mv $benchmark_dir/logs/* "$benchmark_dir/results/reconfig_${computation_time}_scalog_with_e2e"
