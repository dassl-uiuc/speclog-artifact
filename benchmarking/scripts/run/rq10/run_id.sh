...
do
    ...
    run_id
    mkdir -p $benchmark_dir/results/apps/intrusion_detection/scalog_$i
    sudo cp -r ../../applications/vanilla_applications/intrusion_detection/data $benchmark_dir/results/apps/intrusion_detection/scalog_$i
done
