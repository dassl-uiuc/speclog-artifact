...
run_hft() {
    ...
    do
        ...
        do
            ...
            mkdir "../../applications/vanilla_applications/hft/analytics"
            rm -rf "../../applications/vanilla_applications/hft/data"
            mkdir "../../applications/vanilla_applications/hft/data"
...
do
    ...
    run_hft
    mkdir -p $benchmark_dir/results/apps/hft/scalog_$trial
    cp -r ../../applications/vanilla_applications/hft/data $benchmark_dir/results/apps/hft/scalog_$trial
done
