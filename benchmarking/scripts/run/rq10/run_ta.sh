...
do
    ...
    run_ta
    mkdir -p $benchmark_dir/results/apps/transaction_analysis/scalog_$i
    sudo cp -r ../../applications/vanilla_applications/transaction_analysis/data $benchmark_dir/results/apps/transaction_analysis/scalog_$i
done
