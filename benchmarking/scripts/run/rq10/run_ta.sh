...
do
    ...
    run_ta
    mkdir -p $results_dir/apps/transaction_analysis/speclog_$trial
    cp -r ../../applications/vanilla_applications/transaction_analysis/data $results_dir/apps/transaction_analysis/speclog_$trial
done
